...
router.get('/', (req, res) => {
    const queryText = 'SELECT "user"."id", "user"."username", "user"."access_id", "access_type"."clearance" FROM "user" JOIN "access_type" ON "user"."access_id" = "access_type"."id" ORDER BY "username" ASC;'
