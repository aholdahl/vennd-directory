...
router.post('/', (req, res)=>{
    ...
    pool.query(queryText,[req.user.id, req.body.business_id, req.body.demographic_id, req.body.direction])
    .then((result)=>{
        res.sendStatus(200)
    }).catch((error)=>{
        console.log(error);
...
router.put('/', (req, res)=>{
    ...
    pool.query(queryText, [req.body.direction, req.user.id, req.body.business_id, req.body.demographic_id])
    .then((result)=>{
        res.sendStatus(200)
    }).catch((error)=>{
        console.log(error)
